...
static int SPI1_FULL_DMA_init(void)
{
    ...
    */
    ...
    LL_DMA_ConfigAddresses(SPI_MLINE_DMA, 
                           ...
                           LL_SPI_DMA_GetRegAddr(SPI_MLINE_SPI), (uint32_t)SPI1_FULL_DMA_rx_buffer.dt_buffer,
                           LL_DMA_GetDataTransferDirection(SPI_MLINE_DMA, SPI_MLINE_DMA_STREAM_RX));
    LL_DMA_SetDataLength(SPI_MLINE_DMA, SPI_MLINE_DMA_STREAM_RX, SPI1_FULL_DMA_rx_buffer.dt_count);

    LL_DMA_ConfigAddresses(SPI_MLINE_DMA,
                           SPI_MLINE_DMA_STREAM_TX, (uint32_t)SPI1_FULL_DMA_tx_buffer.dt_buffer,
                           LL_SPI_DMA_GetRegAddr(SPI_MLINE_SPI),
                           LL_DMA_GetDataTransferDirection(SPI_MLINE_DMA, SPI_MLINE_DMA_STREAM_TX));
    LL_DMA_SetDataLength(SPI_MLINE_DMA, SPI_MLINE_DMA_STREAM_TX, SPI1_FULL_DMA_tx_buffer.dt_count);
    ...
    irq_attach(SPI_MLINE_DMA_IRQ_TX, SPI1_FULL_DMA_tx_irq_handler, 0, NULL, "SPI1_FULL_DMA_irq_handler"); // like NVIC_SetPriority(DMA2_Stream5_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),0, 0));
    irq_attach(SPI_MLINE_DMA_IRQ_RX, SPI1_FULL_DMA_rx_irq_handler, 0, NULL, "SPI1_FULL_DMA_irq_handler");
...
{
    LL_DMA_SetDataLength    (SPI_MLINE_DMA, SPI_MLINE_DMA_STREAM_TX, SPI1_FULL_DMA_RXTX_BUFFER_SIZE); //устанавливаем сколько символов передачть
    LL_DMA_SetDataLength    (SPI_MLINE_DMA, SPI_MLINE_DMA_STREAM_RX, SPI1_FULL_DMA_RXTX_BUFFER_SIZE);
    LL_DMA_EnableStream     (SPI_MLINE_DMA, SPI_MLINE_DMA_STREAM_RX); //enable receive
...
STATIC_IRQ_ATTACH(SPI_MLINE_DMA_IRQ_TX, SPI1_FULL_DMA_tx_irq_handler, NULL);
/**
...
STATIC_IRQ_ATTACH(SPI_MLINE_DMA_IRQ_RX, SPI1_FULL_DMA_rx_irq_handler, NULL);
/**
...
static int SPI1_FULL_DMA_receive(struct lthread * self)
{
    ...
    LL_DMA_DisableStream(SPI_MLINE_DMA, SPI_MLINE_DMA_STREAM_RX);                    //отлючаем поток передачи данных
...
{
    LL_DMA_DisableStream    (SPI_MLINE_DMA, SPI_MLINE_DMA_STREAM_RX);
    SPI1_FULL_DMA_rx_buffer.dt_count = datalength;
    LL_DMA_SetDataLength    (SPI_MLINE_DMA, SPI_MLINE_DMA_STREAM_RX, datalength);
    LL_DMA_EnableStream (SPI_MLINE_DMA, SPI_MLINE_DMA_STREAM_RX);
    return 0;
}
